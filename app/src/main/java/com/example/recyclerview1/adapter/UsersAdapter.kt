...
//        val isSameUserItem = oldItem is User && newItem is User && oldItem.id == newItem.id
//        val isSameStudentItem = oldItem is Student && newItem is Student && oldItem.id == newItem.id
//        return isSameStudentItem || isSameUserItem
//    }
//
...
//
//    var users: List<DataModel> = ArrayList()
//    set(newValue){
//        val diffCallback = UsersDiffCallback(field, newValue)
////        val diffResult = DiffUtil.calculateDiff(diffCallback)
//        val diffResult = AsyncListDiffer(this, diffCallback)
//        field = newValue
...
//                holder.itemView.setBackgroundColor(ContextCompat.getColor(context, R.color.no_bg))
//            }
//            else{
//                tvCompany.text = context.getString(R.string.unemployed)
//                holder.itemView.setBackgroundColor(ContextCompat.getColor(context, R.color.fire))
//            }
//
